...
Check out [generics](https://phpstan.org/blog/generics-in-php-using-phpdocs) and [conditional return types](../writing-php-code/phpdoc-types.md#conditional-return-types) to learn more.
...
Finally, register the extension in the [configuration file](../config-reference.md):
