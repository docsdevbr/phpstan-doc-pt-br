...
PHPStan outputs errors via so-called error formatters. See the [list of built-in error formatters](../user-guide/output-format.md).
...
Before you can start using your custom error formatter, you have to register it in the [configuration file](../config-reference.md):
